    ...
    switch (laptopType) {
      case 'standard':
        if (LaptopMonthsInUse < 48) {
          LaptopResidualValue = (LaptopPurchasePrice * 0.90) / 48) * LaptopMonthsInUse));
      ...
      case 'power':
        if (LaptopMonthsInUse < 48) {
          LaptopResidualValue = (LaptopPurchasePrice * 0.85) / 48) * LaptopMonthsInUse));
      ...
      case 'macbook':
        if (LaptopMonthsInUse < 60) {
          LaptopResidualValue = (LaptopPurchasePrice * 0.80) / 60) * LaptopMonthsInUse));
